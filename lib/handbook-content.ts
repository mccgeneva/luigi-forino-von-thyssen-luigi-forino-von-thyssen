    ...
    subsections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Borrowed funds carry debit interest under a risk-based scale — a higher leverage multiple carries more risk and a higher annual rate: 2% at 1:2, 3% at 1:5, 8% at 1:10, 10% at 1:15, 14% at 1:20, 18% at 1:25 and 22% at 1:30. Interest accrues from the moment the line is activated. When you switch a line off, the accrued interest is settled and the borrowed principal is repaid from your balance. Each line is denominated in your account's currency (EUR, USD, GBP, or CHF), and both activation and switch-off require Administrator approval.",
        ],
        bullets: [
          "Selectable leverage ratios from 1:2 up to 1:30.",
          "Live preview of borrowed funds, buying power, and interest before submitting.",
          "Risk-based debit interest (2% at 1:2 up to 22% at 1:30) on borrowed funds, settled on switch-off.",
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Leveraged trading lines carry debit interest on borrowed funds under a risk-based scale — a higher ratio carries more risk and a higher rate (2% at 1:2, 3% at 1:5, 8% at 1:10, 10% at 1:15, 14% at 1:20, 18% at 1:25, 22% at 1:30) — accruing from activation. When a line is switched off, accrued interest is settled and the borrowed principal is repaid from your balance. There are no separate activation fees — the cost is the transparent interest on what you actually borrow.",
        ],
      },
      {
